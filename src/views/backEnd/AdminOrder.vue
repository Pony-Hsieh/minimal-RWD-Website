  ...
  <div>
    ...
    <div class="container">
      ...
      <table v-if="rawData.length != 0"
        class="table table-bordered table-striped table-responsive-lg mt-4 w-100"
      >
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-12 col-lg-8">
                ...
                <div v-for="(item, index) in tempOrder.products"
                  :key="index"
