                    ...
                    <div class="modal-body">
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="percent" v-model="tempCoupon.percent" type="number" max="100" min="0"
                                    class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <input id="is_enabled" v-model="tempCoupon.is_enabled" class="form-check-input"
        ...
        <div id="couponDeleteModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <span class="h6">{{ deleteCouponTitle }}</span>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            deleteCoupon() {
                const vm = this;
                const api = `${process.env.VUE_APP_APIPATH}/api/${process.env.VUE_APP_CUSTOMPATH}/admin/coupon/${this.deleteCouponID}`;
