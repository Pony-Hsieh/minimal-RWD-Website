<template>
    <div class="message-alert">
        <div v-for="(item, i) in receiveMessages" :key="i" class="alert alert-dismissible"
            :class="'alert-' + item.status" role="alert">
            <div v-html="item.message" />
            <button type="button" class="close" data-dismiss="alert" aria-label="Close" @click="removeMessage(i)">
